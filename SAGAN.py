...
''' End of Implementation of attention module'''
...
# Here we are calculating the FID score at every 5 epochs. Total number of epochs is 215.
W_loss = []
generator_loss = []
discriminator_loss = []
fid_scores = []
...
discriminator.save('SAGAN_DISCRIMINATOR.h5')
